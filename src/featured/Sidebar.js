      ...
      <div className="p-4">
        <div className="flex justify-center items-center">
          <div className="flex items-center">
            <img src="https://smartmag.theme-sphere.com/tech-blog/wp-content/uploads/sites/35/2022/11/techblog-logo-dark@2x.png" alt="Logo" className="w-30 h-10 mr-2" />
          </div>
        ...
        <div className="mt-8 text-center pr-6">
          <div className="border p-6 rounded-lg bg-black h-[25rem]">
            ...
            <form className="mt-4">
              ...
              <button type="submit" className="w-full bg-violet-500 text-bold text-white p-3 mt-2 rounded">Subscribe</button>
        ...
        <div className="mt-8">
          ...
          <div className="mt-4 space-y-4">
            <a href="#" className="flex items-center text-white">
              <img src="https://smartmag.theme-sphere.com/tech-blog/wp-content/uploads/sites/35/2022/11/thisisengineering-raeng-a7A9O5htrKs-unsplash-1024x683.jpg" alt="Hot item 1" className="w-24 h-20 mr-4 rounded-lg" />
              <div>
            ...
            <a href="#" className="flex items-center text-white">
              <img src="https://smartmag.theme-sphere.com/tech-blog/wp-content/uploads/sites/35/2022/11/Depositphotos_242235046_xl-2015-1-1024x582.jpg" alt="Hot item 2" className="w-24 h-20 mr-4 rounded-lg" />
              <div>
            ...
            <a href="#" className="flex items-center text-white">
              <img src="https://smartmag.theme-sphere.com/tech-blog/wp-content/uploads/sites/35/2022/11/remy_loz-3vVzdb8KKIw-unsplash-1024x683.jpg" alt="Hot item 3" className="w-24 h-20 mr-4 rounded-lg" />
              <div>
