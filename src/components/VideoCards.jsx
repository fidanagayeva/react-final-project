            ...
            <div className="flex mb-6 ml-[3rem] mr-[3rem]">
                <div className="w-[72%] pr-4">
                    <div className="bg-gray-800 rounded-lg overflow-hidden relative mb-6 w-full">
                        <img src="https://smartmag.theme-sphere.com/tech-blog/wp-content/uploads/sites/35/2022/11/sajad-nori-CeyE899Q73Y-unsplash-768x512.jpg" alt="" className="w-full h-[27rem] object-cover"/>
                        ...
                        <div className="p-4 absolute bottom-0 left-0 w-full">
                            ...
                            <div className="bg-black bg-opacity-60 p-2 rounded w-fit">
                                <h3 className="text-2xl font-bold">Soundcore VR Gaming Earbuds Designed for <br /> Meta Quest 2 Launched</h3>
                            </div>
                    ...
                    <div className="grid grid-cols-4 gap-4 w-[76rem]">
                        {[
                            ...
                            <div key={id} className="relative flex felx-col items-center h-[16rem] w-full"> 
                ...
                <div className="w-[28%] pl-4 flex flex-col space-y-4">
                    {[
